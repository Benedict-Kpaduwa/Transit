...
export const stationApi = {
    ...
    getAllStationsByLineSorted: async (): Promise<{ red: Station[]; blue: Station[] }> => {
        try {
    ...
    getAllRouteLines: async (): Promise<{ red: RouteLine[]; blue: RouteLine[] }> => {
        try {
...
function transformStations(geojson: GeoJSONFeatureCollection): Station[] {
    return geojson.features
        ...
        .map(feature => {
            ...
            const line = properties.line?.includes('RED') ? 'Red' as const : 'Blue' as const;
